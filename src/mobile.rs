...
pub fn init<R: Runtime, C: DeserializeOwned>(
    ...
    let handle = api.register_android_variant::<MusicNotification<R>>("com.plugin.music_notification", "MusicNotificationPlugin")?;
    #[cfg(target_os = "ios")]
...
impl<R: Runtime> MusicNotification<R> {
    ...
    pub fn set_normalization_config(
        ...
        self.0
            .run_mobile_plugin("setNormalizationConfig", payload)
            .map_err(Into::into)
    }
