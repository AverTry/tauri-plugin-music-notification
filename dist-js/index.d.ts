...
export declare function onPlay(handler: () => void): Promise<PluginListener>;
export declare function onPause(handler: () => void): Promise<PluginListener>;
export declare function onNext(handler: () => void): Promise<PluginListener>;
export declare function onPrev(handler: () => void): Promise<PluginListener>;
